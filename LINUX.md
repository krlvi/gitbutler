...
- Arch Linux (supported; known to work well)
  - [gitbutler](https://aur.archlinux.org/packages/gitbutler) (AUR)
  - [gitbutler-bin](https://aur.archlinux.org/packages/gitbutler-bin) (AUR)
- Flatpak
